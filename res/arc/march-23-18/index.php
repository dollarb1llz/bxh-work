<?php $page_title = "Ideas"; include 'res/inc/header.php'; ?>
  ...
  <div class="container bg">
    ...
    <p>
      ...
      <span>I'm already having difficulties with it though.</span>
        <span>brk</span>
      <span>Well we converted to .php! Fuck yeah man.</span>
      <span>Now we can link our header and other includes.</span>
      <span>I'm thinking about going to sleep now so what to do tomorrow?</span>
      <span>An idea is to finish up some things with the webpage like mobility and Navigation.</span>
    </p>
    <img src="./res/img/anakin-cmm.jpg" class="left" />
    <p>
      <span>I should alternate between platforms everyday for getting my daily thoughts on paper.</span>
      <span>Steven is getting Twitter back! And twitter is fucking awesome. </span>
      <span>Imagine how great these platforms can be under conservative control.</span>
      <span>So lets not give up on the platforms just yet, alternate everyday.</span>
        <span>brk</span>
      </p>
    <div class="c"></div>
  </div>
