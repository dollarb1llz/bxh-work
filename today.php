<?php $page_title = "Today"; include 'res/inc/header.php'; ?>

    <!--Supporting -->
      <div class="color-box pitch-dark">
        <div class="banner horizon">
          <h1>Daily Update</h1>
          <h2>March 22nd, 2018</h2>
        </div>
        <div class="container today bg">
            <div class="trips-img left">
              <div>
                <img src="./res/img/billy-outside-1.jpg" />
              </div>
              <div>
                <img src="./res/img/miley-car.jpg" />
              </div>
              <div>
                <img src="./res/img/pov-car.jpg" />
              </div>
            </div>
            <p>
            ...
            <video class="" controls>
              <source src="./res/img/cat-vg.mp4" type="video/mp4" />
